...
import { createTestAction } from "@/lib/admin-actions";
...
export default function NewTestPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const res = await createTestAction(jsonInput);
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          <div className="p-6 border-b border-gray-200 bg-gray-50/50">
            <h1 className="text-2xl font-bold flex items-center gap-2">
              <FileJson className="w-6 h-6 text-blue-600" /> Add New Test
            </h1>
            <p className="text-sm text-gray-500 mt-1">Paste the full JSON representation of the `IeltsReadingTest` here.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="p-6">
            ...
            <div className="mb-6">
              ...
              <textarea 
                ...
                className="w-full h-96 p-4 border border-gray-300 rounded-lg font-mono text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none resize-y"
                placeholder="{\n  &quot;id&quot;: &quot;cambridge_16_test_2&quot;,\n  &quot;title&quot;: &quot;Cambridge Ielts 16 Reading Test 2&quot;,\n  ..."
                spellCheck={false}
              />
            </div>
