...
export default function ListeningTestLandingClient({ testData, user, dbAttempts }: Props) {
  ...
  return (
    <div className="min-h-screen bg-background py-32 px-6 font-body text-foreground">
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        >
          <div className="flex gap-3 mb-6">
            <span className="bg-black/5 text-foreground/80 px-3 py-1 text-xs font-semibold uppercase tracking-wider rounded-md border border-black/5 flex items-center gap-1">
              <Headphones className="w-3 h-3" /> IELTS Academic
            </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-muted-foreground text-sm mb-10">
            <div className="flex items-center gap-3">
              ...
              <span>30 Minutes • {testData.parts.length} Sections • {totalQuestions} Questions</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-full bg-black/5 flex items-center justify-center">
