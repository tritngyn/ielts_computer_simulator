      ...
      <div className="max-w-5xl mx-auto space-y-8">
        ...
        >
          ...
          <div className="flex gap-3 mb-4">
            <span className="bg-gray-100 text-gray-600 px-3 py-1 text-xs font-bold rounded-sm border border-gray-200 flex items-center gap-1">
          ...
          <div className="space-y-3 text-text-secondary text-sm">
            <div className="flex items-center gap-2">
              <Clock className="w-4 h-4" /> Thời gian làm bài: 30 phút |{" "}
              {testData.parts.length} phần thi | {totalQuestions} câu hỏi |
              3813 bình luận
            </div>
            <div className="flex items-center gap-2">
