...
const cambridgeTests = [
  { id: 1, book: "Cambridge IELTS 18", test: 1, sections: 4, questions: 40, time: 30, difficulty: "Intermediate" },
  { id: 2, book: "Cambridge IELTS 18", test: 2, sections: 4, questions: 40, time: 30, difficulty: "Intermediate" },
  { id: 3, book: "Cambridge IELTS 18", test: 3, sections: 4, questions: 40, time: 30, difficulty: "Advanced" },
  { id: 4, book: "Cambridge IELTS 18", test: 4, sections: 4, questions: 40, time: 30, difficulty: "Advanced" },
  { id: 5, book: "Cambridge IELTS 17", test: 1, sections: 4, questions: 40, time: 30, difficulty: "Intermediate" },
  { id: 6, book: "Cambridge IELTS 17", test: 2, sections: 4, questions: 40, time: 30, difficulty: "Intermediate" },
  { id: 7, book: "Cambridge IELTS 17", test: 3, sections: 4, questions: 40, time: 30, difficulty: "Advanced" },
  { id: 8, book: "Cambridge IELTS 17", test: 4, sections: 4, questions: 40, time: 30, difficulty: "Advanced" },
  { id: 9, book: "Cambridge IELTS 16", test: 1, sections: 4, questions: 40, time: 30, difficulty: "Intermediate" },
  { id: 10, book: "Cambridge IELTS 16", test: 2, sections: 4, questions: 40, time: 30, difficulty: "Intermediate" },
  { id: 11, book: "Cambridge IELTS 16", test: 3, sections: 4, questions: 40, time: 30, difficulty: "Advanced" },
  { id: 12, book: "Cambridge IELTS 16", test: 4, sections: 4, questions: 40, time: 30, difficulty: "Advanced" },
];

const statCards = [
  {
    label: "Total Tests",
    value: cambridgeTests.length,
    icon: FileText,
    paper: "bg-purple-50",
